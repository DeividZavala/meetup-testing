  ...
  return (
    <React.Fragment>
              ...
              <div className='w-full lg:w-3/4 bg-white rounded-lg'>
                <div className='py-12 px-5 text-center'>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    {/* Alert */}
                    {isSubmitted && (
                      <div className='mt-8 flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md'>
                        ...
                        <div className='px-4 py-2 -mx-3'>
                          <div className='mx-3'>
                            ...
                            <p className='text-sm text-gray-600'>Sesión inciada correctamente</p>
                          </div>
                        </div>
                      </div>
                    )}
      ...
      <section className='container p-6 mx-auto bg-white'>
        <h2 className='text-xl font-medium text-gray-800 capitalize md:text-2xl'>Our Team</h2>
